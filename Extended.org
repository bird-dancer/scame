...
** latex
*** bibliography
Use different bibliography processors for HTML and latex exports
#+begin_src emacs-lisp
...
#+end_src
** pulsar
pulse highlight line when jumping between buffers etc.
#+begin_src emacs-lisp
  (use-package pulsar
...
#+end_src
*** corfu-terminal
TODO: can be deleted for Emacs version 31+
#+begin_src emacs-lisp
...
* development
:PROPERTIES:
:header-args: :tangle extended/development.el :results silent :mkdirp yes
:END:
** java
#+begin_src emacs-lisp
