...
simple configurable agreeable modular emacsd
...
#+begin_example
Simple       -  easy to use and read, it’s just setting varaibles and calling functions
Configurable -  everything can be overwritten
Agreeable    -  settings that are up to taste (e.g. font, theme) are left for the user to configure
Modular      -  functionality is split up into different files, that can be loaded separatly from each other
Emacs        -  you know what it is
#+end_example

* how to use
clone the package and put this in the beginning of your init.el
#+begin_src emacs-lisp :tangle no
  (load "~/scame/scame.el" nil t)
#+end_src
you can also just load individual modules. they are named the same as the first level headings in this file e.g.
#+begin_src emacs-lisp :tangle no
  (load "~/scame/keybindings.el" nil t)
#+end_src

* scame.el
load this file to load all modules below
:PROPERTIES:
:header-args: :tangle scame.el :results silent :mkdirp yes
:END:
...
* startup
:PROPERTIES:
:header-args: :tangle startup.el :results silent :mkdirp yes
:END:
...
* user interface
:PROPERTIES:
:header-args: :tangle user-interface.el :results silent :mkdirp yes
:END:
** disable bars
#+begin_src emacs-lisp
  (menu-bar-mode 0)
...
* keybindings
:PROPERTIES:
:header-args: :tangle keybindings.el :results silent :mkdirp yes
:END:
...
#+end_src
** bind M-<backspace> to delete in the search string during isearch
#+begin_src emacs-lisp
...
* completion
:PROPERTIES:
:header-args: :tangle completion.el :results silent :mkdirp yes
:END:
...
* org-mode
:PROPERTIES:
:header-args: :tangle org-mode.el :results silent :mkdirp yes
:END:
** org agenda
#+begin_src emacs-lisp
...
* var
:PROPERTIES:
:header-args: :tangle var.el :results silent :mkdirp yes
:END:
** which key mode
#+begin_src emacs-lisp
  (which-key-mode t)
...
* dired-settings
:PROPERTIES:
:header-args: :tangle dired-settings.el :results silent :mkdirp yes
:END:
...
* editor-config
:PROPERTIES:
:header-args: :tangle editor-config.el :results silent :mkdirp yes
:END:
** folding code blocks
